...
export default function HijriSkeleton() {
  return (
    <div className="space-y-6 animate-pulse px-1">
      ...
      <div className="bg-card-light dark:bg-card-dark rounded-2xl p-8 border border-gray-100 dark:border-gray-800 shadow-card">
      ...
      <div className="p-6 rounded-2xl bg-black/5 dark:bg-white/5 border border-gray-100 dark:border-gray-800 space-y-4">
      ...
      <div className="p-6 rounded-2xl bg-emerald-500/5 dark:bg-emerald-500/10 border border-emerald-500/10 space-y-4">
