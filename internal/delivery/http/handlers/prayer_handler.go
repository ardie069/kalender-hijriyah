...
// @Param method query string false "Metode (contoh: KEMENAG, MWL, ISNA, UMM_AL_QURA)"
// @Param madhab query string false "Madzhab (shafii, hanafi)"
// @Param high_lat query string false "Metode lintang tinggi (ANGLE_BASED, dll)"
